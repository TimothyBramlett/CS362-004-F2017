...
int great_hall_Func(struct gameState *state, int currentPlayer, int handPos){
  //+1 Card
  drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurerFunc(state, currentPlayer, cardDrawn, drawntreasure, z, temphand);
    ...
    case smithy:
      return smithyFunc(i, currentPlayer, state, handPos);
    ...
    case great_hall:
      return great_hall_Func(state, currentPlayer, handPos);
